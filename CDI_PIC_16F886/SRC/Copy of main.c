...
void main (void)
{
    ...
    unsigned char Selected_DELAY_Table;
    ...
    Selected_DELAY_Table =SEL_VALUE;
    ...
    while(1)
    {
       ...
       {                                       // se timer overflow ci ha messo troppo (bassi giri no delay)
         ...
         if( Selected_DELAY_Table == 1)
         {
           DelayTime = DELAY_Table_1[DeltaTime];
         }
         else if ( Selected_DELAY_Table == 1)
         {
           DelayTime = DELAY_Table_2[DeltaTime];
         }
         else
         {
